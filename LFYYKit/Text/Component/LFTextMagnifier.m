...
@interface _LFTextMagnifierCaret : LFTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _LFTextMagnifierCaret
...
- (LFTextMagnifierType)type {
    return LFTextMagnifierTypeCaret;
}
...
@interface _LFTextMagnifierRanged : LFTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _LFTextMagnifierRanged
#define kMultiple 1.2
...
- (LFTextMagnifierType)type {
    return LFTextMagnifierTypeRanged;
}
...
@implementation LFTextMagnifier

+ (id)magnifierWithType:(LFTextMagnifierType)type {
    switch (type) {
        case LFTextMagnifierTypeCaret :return [_LFTextMagnifierCaret new];
        case LFTextMagnifierTypeRanged :return [_LFTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[LFTextMagnifier class]]) {
