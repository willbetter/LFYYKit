...
/**
 The LFTextParser protocol declares the required method for LFTextView and LFLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 LFTextView and LFLabel. See `LFTextSimpleMarkdownParser` and `LFTextSimpleEmoticonParser` for example.
 */
@protocol LFTextParser <NSObject>
@required
/**
 When text is changed in LFTextView or LFLabel, this method will be called.
 ...
 no selected range (such as LFLabel), this value is NULL.
 ...
 */
@interface LFTextSimpleMarkdownParser : NSObject <LFTextParser>
 ...
 */
@interface LFTextSimpleEmoticonParser : NSObject <LFTextParser>
