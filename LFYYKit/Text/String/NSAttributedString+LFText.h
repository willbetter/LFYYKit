...
/**
 ...
 All properties defined in UIKit, CoreText and LFText are included.
 */
@interface NSAttributedString (LFText)
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  LFText:6.0
 */
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:6.0  UIKit:7.0  LFText:6.0
 */
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:6.0  UIKit:6.0  LFText:6.0
 */
...
/**
 ...
 @discussion Default is 0.
 @discussion Get this property returns the first character's attribute.
 @since CoreText:7.0  UIKit:7.0  LFText:7.0
 */
...
#pragma mark - Get LFText attribute as property
///=============================================================================
/// @name Get LFText attribute as property
///=============================================================================
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readonly) LFTextShadow *textShadow;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readonly) LFTextShadow *textInnerShadow;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readonly) LFTextDecoration *textUnderline;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readonly) LFTextDecoration *textStrikethrough;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readonly) LFTextBorder *textBorder;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readonly) LFTextBorder *textBackgroundBorder;
...
#pragma mark - Query for LFText
///=============================================================================
/// @name Query for LFText
///=============================================================================

/**
 Returns the plain text from a range.
 If there's `LFTextBackedStringAttributeName` attribute, the backed string will
...
#pragma mark - Create attachment string for LFText
///=============================================================================
/// @name Create attachment string for LFText
///=============================================================================
...
/**
 ...
 Example: ContentMode:bottom Alignment:Top.
      ...
      The text       The attachment
         ↓                 ↓
     ───────┌────────────────────┐───────
        / \   │                          │ / ___|
       / _ \  │                          │| |
      / ___ \ │                          │| |___          ← The text line
     /_/   \_\│    ⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎     │ \____|
     ───────│    ⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎     │───────
              │    ⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎     │
              │    ⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎ ←───────────────── The attachment content
              │    ⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎⬛︎     │
              └────────────────────┘
 
 @param content        The attachment (UIImage/UIView/CALayer).
 @param attachmentSize The attachment size in text layout.
 @param alignment      The attachment's alignment.
...
/**
 ...
 If NO, it should be drawn with CoreText or LFText.
...
/**
 ...
 All properties defined in UIKit, CoreText and LFText are included.
 */
@interface NSMutableAttributedString (LFText)
...
#pragma mark - Set LFText attribute as property
///=============================================================================
/// @name Set LFText attribute as property
///=============================================================================
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readwrite) LFTextShadow *textShadow;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readwrite) LFTextShadow *textInnerShadow;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readwrite) LFTextDecoration *textUnderline;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readwrite) LFTextDecoration *textStrikethrough;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readwrite) LFTextBorder *textBorder;
...
/**
 ...
 @since LFText:6.0
 */
@property (nonatomic, strong, readwrite) LFTextBorder *textBackgroundBorder;
